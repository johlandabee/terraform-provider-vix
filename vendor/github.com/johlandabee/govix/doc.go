...
// Example:
//
//  * OSX: export DYLD_LIBRARY_PATH=${GOPATH}/src/github.com/johlandabee/govix
//  * Linux: export LD_LIBRARY_PATH=${GOPATH}/src/github.com/johlandabee/govix
